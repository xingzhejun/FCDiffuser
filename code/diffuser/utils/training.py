...
class Trainer(object):
    ...
    def save(self):
        ...
        if self.model.if_base:
            savepath = os.path.join(self.bucket, logger.prefix, 'base_stage', 'checkpoint')
        else:
            savepath = os.path.join(self.bucket, logger.prefix, 'refinement_stage', 'checkpoint')
